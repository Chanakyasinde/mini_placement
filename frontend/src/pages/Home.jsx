...
export default function Home() {
  const handleCompanyClick = () => {
    alert("To hire the best talent , Please signup first");
  };

  const handleStudentClick = () => {
    alert("To find the best jobs , Please signup first");
  };
      ...
      <section className="main-section">
        <div className="main-container">
          ...
          <div className="home-selection-container">
            <div className="selection-box company-box">
              <h2 className="box-title">For Companies</h2>
              <p className="box-desc">
                The place where you can find the best talent.
              </p>
              <button className="btn-selection" onClick={handleCompanyClick}>
                Hire Students
              </button>
            </div>

            <div className="selection-box student-box">
              <h2 className="box-title">For Students</h2>
              <p className="box-desc">
                Launch your dream career with top companies.
              </p>
              <button className="btn-selection" onClick={handleStudentClick}>
                Find Jobs
              </button>
            </div>
          </div>
